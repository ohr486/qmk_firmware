 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |  L1  |AltShf| LCmd | LCmd | LEFT |                                       | LEFT |  UP  | DOWN | RIGHT|  _   |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,---------------.
...
[SYMB] = KEYMAP(
       // left hand
       KC_NO,   KC_EXLM, S(KC_QUOT), KC_DLR,  KC_PERC, S(KC_7), KC_NO,
       KC_NO,   KC_NO,   KC_AT,      KC_LCBR, KC_RCBR, KC_PIPE, KC_TRNS,
       KC_NO,   KC_HASH, KC_DLR,     KC_LPRN, KC_RPRN, KC_GRV,
       KC_NO,   KC_PERC, KC_CIRC,    KC_LBRC, KC_RBRC, KC_TILD, KC_TRNS,
       KC_TRNS, KC_NO,   KC_NO,      KC_NO,   KC_NO,
                                     KC_NO,   KC_NO,
                                              KC_NO,
                           KC_NO,    KC_TRNS, KC_NO,
       // right hand
       KC_NO,   KC_QUOT, KC_NO,  KC_NO,   KC_TILD,  KC_EQL,      KC_CIRC,
       KC_NO,   KC_NO,   KC_NO,  KC_NO,   KC_LBRC,  KC_GRV,      KC_LCBR,
                KC_NO,   KC_NO,  KC_NO,   KC_RBRC,  S(KC_EQL),   KC_RCBR,
       KC_NO,   KC_NO,   KC_NO,  KC_NO,   KC_MINUS, S(KC_MINUS), KC_NO,
